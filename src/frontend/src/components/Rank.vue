...
<script>
    ...
    export default {
        ...
        created() {
            ...
            let json = proxy.methods.paging(`${this.$store.state.search.context}/help/null/0`)
            this.$store.state.search.list = json.help
